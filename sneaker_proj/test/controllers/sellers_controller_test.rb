...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post sellers_url, params: { seller: { birthday: @seller.birthday, email: @seller.email, first_name: @seller.first_name, last_name: @seller.last_name, password_digest: @seller.password_digest, sex: @seller.sex } }
    end
  ...
  test "should update seller" do
    patch seller_url(@seller), params: { seller: { birthday: @seller.birthday, email: @seller.email, first_name: @seller.first_name, last_name: @seller.last_name, password_digest: @seller.password_digest, sex: @seller.sex } }
